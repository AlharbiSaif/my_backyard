	...
	event.waitUntil(
		caches.open(OFFLINE_CACHE).then(function(cache) {
			...
			return cache.addAll([
				...
				"/my_backyard/img/flowers.svg",
				"/my_backyard/img/reminders.svg",
				"/my_backyard/img/shopping.svg",
				"/my_backyard/img/weather.svg",
				"/my_backyard/img/wildlife.svg",
				"/my_backyard/img/arrowright.svg",
